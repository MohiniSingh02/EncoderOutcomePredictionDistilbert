...
class ClassificationModel(LightningModule):
    def __init__(self,
        ...
        self.model = None
        self.classifier_icd10 = None
        self.classifier_icd9 = None
    ...
    def predict_step(self, batch, batch_idx):
        return self(batch['input_ids'], batch['attention_mask'], labels=batch['labels'], task=batch['task'],
                    return_dict=True, tuned=True)

    def test_step(self, batch, batch_idx) -> Optional[STEP_OUTPUT]:
        result = self(batch['input_ids'], batch['attention_mask'], labels=batch['labels'], task=batch['task'],
                      return_dict=True, tuned=True)
